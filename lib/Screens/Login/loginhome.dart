...
class LoginHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: MediaQuery( // ⛔️ Override system font scaling
        data: MediaQuery.of(context).copyWith(textScaleFactor: 1.0),
        child: Scaffold(
          body: SafeArea(
            // 🔴 CHANGE 1: Yahan se SingleChildScrollView hata diya gaya hai
            child: Column(
              children: [
                // Logo Image
                Container(
                  padding: EdgeInsets.only(top: screenHeight * 0.05), // Thoda top padding adjust kiya
                  child: Image.asset(
                    'assets/splashqc.png',
                ...
                // 🔴 CHANGE 2: Image ko Expanded mein wrap kiya aur fixed height hata di
                Expanded(
                  child: Align( // 🔴 Center ki jagah Align ka use karein
                    alignment: Alignment.bottomCenter, // 🔴 Image ko niche push karega
                    child: Padding(
