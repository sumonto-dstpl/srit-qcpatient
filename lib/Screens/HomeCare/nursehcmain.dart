...
class NurseHCMain extends StatefulWidget {
  int selectedIndex = 0;
  NurseHCMain({
    super.key,
  });
  @override
  State<NurseHCMain> createState() => NurseHCMainstate();
}

class NurseHCMainstate extends State<NurseHCMain> {
  String usernameValue = "Nurse";
