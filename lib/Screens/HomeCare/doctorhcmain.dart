...
class DoctorHCMain extends StatefulWidget {
  int selectedIndex = 0;
  DoctorHCMain({
    super.key,
  });
  @override
  State<DoctorHCMain> createState() => DoctorHCMainstate();
}

class DoctorHCMainstate extends State<DoctorHCMain> {
  String usernameValue = "Doctor";
