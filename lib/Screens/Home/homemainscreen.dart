...
//   APIService apiService = new APIService();
  ...
  final List<Map<String, dynamic>> appointmentsData = DummyData.buildUpcomingAppointments();
                   ...
                   children: <Widget>[
                     Expanded(
                       ...
                       child: ClipRRect(
                         ...
                         child: Image.asset(
                           'assets/drsujeet.png', // DYNAMIC IMAGE
                           fit: BoxFit.fill,
                         ),
                       ),
                     ),
                         ...
                         children: <Widget>[
                           ...
                           Container(
                             ...
                             child: RatingBarIndicator(
                               rating: (doctor['rating'] as num).toDouble(), // DYNAMIC RATING
                               itemCount: 5,
