...
//
//                                                                 Image.asset(
//                                                                   'assets/passwordsuccessalert.png',
  ...
  showticket(context) async {
    ...
    showDialog(
      // barrierColor: Colors.white30,
        barrierDismissible: false,
        context: context,
        barrierColor: Colors.transparent, // allow the blur to show
        builder: (BuildContext context) {
          String contentText = "Content of Dialog";
          return StatefulBuilder(builder: (context, setState) {
            return
              ...
              Stack(
                  children: [
                    BackdropFilter(
                      ...
                      child: Container(
                        // color: Colors.black.withOpacity(0.0), // optional dark overlay
                      ),
                    ),
                    Dialog(
                        backgroundColor: Colors.transparent,
