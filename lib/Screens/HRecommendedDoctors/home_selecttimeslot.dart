...
import 'package:newfolder/Screens/HRecommendedDoctors/home_mybockings.dart';
...
class HomeSelectTimeSlot extends StatefulWidget {
  ...
  @override
  State<HomeSelectTimeSlot> createState() => SelectTimeSlotstate();
}

class SelectTimeSlotstate extends State<HomeSelectTimeSlot> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //         leftChevronVisible:
                    //             false, // Hide default left chevron
                    //         rightChevronVisible:
                    //             false, // Hide default right chevron
                    //       ),
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => HomeMyBookingsMain(
