...
class HomeMyBookingsMain extends StatefulWidget {
  final String selectedDate;
  final String selectedTime;
  const HomeMyBookingsMain({
    super.key,
    required this.selectedDate,
    required this.selectedTime,
  });
  @override
  State<HomeMyBookingsMain> createState() => MyBookingsMainstate();
}

class MyBookingsMainstate extends State<HomeMyBookingsMain> {
                      ...
                      child: DecoratedBox(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              width: double.infinity,
                              padding: EdgeInsets.all(0),  // Removed any padding for outer container
                              decoration: BoxDecoration(
                                color: Colors.white,
                                borderRadius: BorderRadius.only(
