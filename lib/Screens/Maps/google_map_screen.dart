      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return  DraggableScrollableSheet(
                ...
                initialChildSize: _currentChildSize2, // Start at 50% of screen height
                minChildSize: 0.3, // Minimum height (30% of screen)
                maxChildSize: 0.9, // Max height (90% of screen)
                expand: false,
                                                          ...
                                                          children: [
                                                            Focus(
                                                              ...
                                                              child: TextFormField(
                                                                ...
                                                                controller: AddressTitleEditTextController,
                                                                inputFormatters: [
                                                                  LengthLimitingTextInputFormatter(100),
      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return  DraggableScrollableSheet(
                ...
                initialChildSize: _currentChildSize3, // Start at 50% of screen height
                minChildSize: 0.3, // Minimum height (30% of screen)
                maxChildSize: 0.9, // Max height (90% of screen)
                expand: false,
                                                ...
                                                child: Container(
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: Image.asset(
                                                      ...
                                                      width: MediaQuery.of(context).size.height * 0.1, // Adjust width
                                                      fit: BoxFit.fill,
                                                     ),
                                                  ),
                                                )
