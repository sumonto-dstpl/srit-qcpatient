...
// Format its date
  ...
  Widget build(BuildContext context) {
    ...
    final filteredEntries = allEntries.where((entry) {
      return entry.date
              .isAfter(allDates[_startIndex].subtract(Duration(days: 1))) &&
    ...
    return Scaffold(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: SliderTheme(
                            data: SliderTheme.of(context).copyWith(
                              thumbColor: Colors
                                  .white, // Customize to your desired color
                              thumbShape: RingThumbShape(),
                              overlayColor: Colors
                                  .transparent, // 🔹 removes purple effect
                              overlayShape: SliderComponentShape
                                  .noOverlay, // 🔹 removes overlay shape
                              showValueIndicator: ShowValueIndicator
                                  .never, // 🔹 disables tooltip text
                        ...
                        Expanded(
                          child: ListView(
                            ...
                            children: _groupEntriesByMonth(filteredEntries)
                                .entries
                                .map((entry) {
                              ...
                              final tiles =
                                  entry.value.map(_buildTimelineTile).toList();
                              count = 0;
                              everyValueLength = 0;
      ...
      bottomNavigationBar:
          CustomBottomNavigationBar(selectedIndex: widget.selectedIndex),
    );
  }

  Map<String, List<TimelineEntry>> _groupEntriesByMonth(
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: Color(0xFF126086),
                                border: Border.all(
                                    color: Color(0xFF126086), width: 2),
                              ),
                            ),
                          ),
                        ]),
