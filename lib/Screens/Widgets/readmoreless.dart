...
class DescriptionTextWidget extends StatefulWidget {
  ...
  int maxLength;
  String? name;
  DescriptionTextWidget({@required this.text, this.maxLength = 40,this.name});
  ...
  void getText() {
    connectivityservice.checkconnectivity().then((intenet) async {
      if (intenet != null && intenet) {
          ...
          about = "${widget.name ?? 'Dr Nutan Bhatt Km'} is a highly experienced General Physician/Internal Medicine specialist in Bengaluru with over ten years of medical practice. He has a wealth of knowledge about treating a wide range of health conditions, including diabetes, diabetic ulcers, insulin treatment, hypertension, and chronic respiratory issues. Dr Faseeh Km also carefully diagnoses and treats common ailments such as fever, cold, infections, and minor injuries.";
          setState(() {
            if (about != null) {
              List<String> words = about.split(" ");
