...
class HomecareOtherservicesAddressScreen extends StatefulWidget {
  const HomecareOtherservicesAddressScreen({super.key});

  @override
  State<HomecareOtherservicesAddressScreen> createState() => _GoogleMapScreenState();
}

class _GoogleMapScreenState extends State<HomecareOtherservicesAddressScreen>
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () async {
                                          if (_sheetController2.isAttached) {
                                            await _sheetController2.animateTo(0.9,duration:Duration(milliseconds: 300),curve: Curves.easeOut,);
                                            Future.delayed(
                                                ...
                                                Focus(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      isDense: true,
                                                      contentPadding:
                                                      EdgeInsets.fromLTRB( height * 0.02, height * 0.012, height * 0.012, height * 0.012,),
                                                      filled: true,
                                      ...
                                      GestureDetector(
                                        onTap: () async {
                                          if (_sheetController2.isAttached) {
                                            await _sheetController2.animateTo(0.9, duration: Duration(milliseconds: 300),curve: Curves.easeOut,);
                                            Future.delayed( Duration(milliseconds: 50), () { _focusNode2.requestFocus(); });
                                          }
                                        },
                                        child: AbsorbPointer(
                                          child: Padding(
                                              ...
                                              children: [
                                                Focus(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      isDense: true,
                                                      contentPadding: EdgeInsets.fromLTRB( height * 0.02, height * 0.012, height * 0.012, height * 0.012, ),
                                                      filled: true,
                                                      fillColor: Color(0xFFFFFFFF),
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                  onTap: () async {
                                                    if (_sheetController2.isAttached) {
                                                      await _sheetController2.animateTo(0.9,duration: Duration(milliseconds: 300),curve: Curves.easeOut,);
                                                      Future.delayed(Duration(milliseconds: 50), () { _focusNode3.requestFocus();});
                                                    }
                                                  },
                                                  child: AbsorbPointer(
                                                    child: Padding(
                                                            ...
                                                            child: GestureDetector(
                                                              onTap: (){
                                                                Map<String, dynamic> addressData = {
                                                                  ...
                                                                  "landmark" : LandmarkEditTextController.text.toString(),
                                                                  "address" : AddressEditTextController.text.toString(),
                                                                };
                                                                Navigator.pop(context);
                                                                Navigator.pop(context, addressData);
                                                              },
