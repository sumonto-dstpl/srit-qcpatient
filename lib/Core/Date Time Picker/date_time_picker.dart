...
class CustomDateTimePickerMedication extends StatefulWidget {
  final String mode;
  final Function(DateTime selectedDate, String selectedTime) onDateTimeSelected;
  final Map<String, List<String>> globallyBookedSlots;
  final Map<String, List<String>> homecareBookedSlots;
  ...
  const CustomDateTimePickerMedication({
    Key? key,
    required this.onDateTimeSelected,
    this.globallyBookedSlots = const {},
    this.mode = '',
  ...
  @override
  State<CustomDateTimePickerMedication> createState() => _CustomDateTimePickerMedicationState();
}

class _CustomDateTimePickerMedicationState extends State<CustomDateTimePickerMedication> {
  late DateTime _selectedDate;
  late DateTime _listStartDate;
  String _selectedCategory = 'Morning';
  String? _selectedTime;
